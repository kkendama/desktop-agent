            ...
            try:
                ...
                if response.usage:
                    ...
                    if "total_tokens" in response.usage:
                        usage_text.append(f"Tokens: {response.usage['total_tokens']} ", style="dim cyan")
                    elif "eval_count" in response.usage:
                        usage_text.append(f"Tokens: {response.usage['eval_count']} ", style="dim cyan")
                    
                    if "total_duration" in response.usage:
                        duration_ms = response.usage["total_duration"] / 1_000_000  # Convert to ms
